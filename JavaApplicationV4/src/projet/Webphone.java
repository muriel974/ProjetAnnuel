...
public class Webphone extends javax.swing.JFrame {
    ...
    public Webphone(String path, String name){
        ...
        panelBlocNordWp.setVisible(false);
        panelBlocSudWp.setVisible(false);
    ...
    private void initComponents() {
        ...
        panelBlocSudWp.setBackground(new java.awt.Color(204, 204, 204));
        ...
        panelBlocFooterWp.setPreferredSize(new java.awt.Dimension(100, 40));
        ...
        panelBlocSudWpLayout.setHorizontalGroup(
            ...
            .add(panelBlocSudWpLayout.createSequentialGroup()
                .add(47, 47, 47)
                .add(panelBlocFooterWp, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 102, Short.MAX_VALUE)
                .add(51, 51, 51))
        );
        panelBlocSudWpLayout.setVerticalGroup(
            panelBlocSudWpLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(org.jdesktop.layout.GroupLayout.TRAILING, panelBlocFooterWp, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 45, Short.MAX_VALUE)
        );

        panelBlocBodyWp.setBackground(new java.awt.Color(0, 0, 255));
        panelBlocBodyWp.setPreferredSize(new java.awt.Dimension(120, 202));
        ...
        panelBlocNordWp.setBackground(new java.awt.Color(204, 204, 204));
        ...
        panelBlocWpLayout.setHorizontalGroup(
            ...
            .add(panelBlocWpLayout.createSequentialGroup()
                ...
                .add(6, 6, 6)
                .add(panelBlocBodyWp, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 117, Short.MAX_VALUE))
            .add(panelBlocSudWp, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        panelBlocWpLayout.setVerticalGroup(
            ...
            .add(panelBlocWpLayout.createSequentialGroup()
                ...
                .add(6, 6, 6)
                .add(panelBlocWpLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        ...
        comboBox2BodyWp.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Droite", "Gauche" }));
        ...
        sliderWidthBodyWp.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                sliderWidthBodyWpStateChanged(evt);
            }
        });
        ...
        sliderHeightBodyWp.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                sliderHeightBodyWpStateChanged(evt);
            }
        });
        ...
        sliderHeightMenuWp.setMaximum(202);
        sliderHeightMenuWp.setValue(202);
        sliderHeightMenuWp.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                sliderHeightMenuWpStateChanged(evt);
            }
        });

        sliderWidthMenuWp.setMaximum(77);
        sliderWidthMenuWp.setToolTipText("");
        sliderWidthMenuWp.setValue(77);
        sliderWidthMenuWp.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                sliderWidthMenuWpStateChanged(evt);
            }
        });
        ...
        sliderHeightFooterWp.setMinimum(50);
        sliderHeightFooterWp.setValue(75);
...
private void button2ActionPerformed(java.awt.event.ActionEvent evt) { 
    ...
    private void comboBox2BodyWpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboBox2BodyWpActionPerformed
       ...
       z= comboBox2BodyWp.getSelectedIndex();
       h7=sliderHeightBodyWp.getValue();
       h6=sliderWidthBodyWp.getValue();

       if(z==0){ // Droite
        
           panelBlocBodyWp.setBounds(100,50,h7,h6); //(0 => gauche et (100 => droite
           System.out.print("Droite");
           System.out.println("La valeur est h6 " + h6);
           System.out.println("La valeur est h7 " + h7);
           validate ();
       }
        if(z==1){// Gauche
        
        panelBlocBodyWp.setBounds(0,50,h7,h6); //(0 => gauche et (100 => droite 
    ...
    private void comboBox2MenuWpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboBox2MenuWpActionPerformed
        ...
        h4=sliderWidthMenuWp.getValue();
        h5=sliderHeightMenuWp.getValue();
        
       if(x==0){ // Gauche
         // panelBlocWp.add(panelBlocMenuWp,BorderLayout.WEST);
        //  panelBlocMenuWp.setPreferredSize(new Dimension(77,202));
           System.out.println("Largeur : "+h4);
           System.out.println("Hauteur : "+h5);
           panelBlocMenuWp.setBounds(0, 50, h4, h5);
           System.out.print("1");
           validate ();
       ...
       if(x==1){ // Droite
            ...
            //panelBlocMenuWp.setPreferredSize(new Dimension(77,202));
           panelBlocMenuWp.setBounds(125, 50, h4, h5); 
           System.out.print("2");
            validate ();
       }
       if(x==2){ // Haut
           // panelBlocWp.add(panelBlocMenuWp,BorderLayout.NORTH);
           // panelBlocMenuWp.setPreferredSize(new Dimension(200,65));
           panelBlocMenuWp.setBounds(0,0,200, 65);
            System.out.print("3");
            validate ();
       }
       ...
       if(x==3){ // Bas
           // panelBlocWp.add(panelBlocMenuWp,BorderLayout.SOUTH);
            //panelBlocMenuWp.setPreferredSize(new Dimension(200,65));
            panelBlocMenuWp.setBounds(0, 235, 200, 65); 
            System.out.print("4");
            validate ();
       }  
    ...
    private void comboBox2FooterWpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboBox2FooterWpActionPerformed
       ...
       if(x==1){ // Gauche
            ...
            System.out.print("WHHAAAZOOOO");
            panelBlocFooterWp.setBounds(0,80-h3,100,h3);
            System.out.print("1");
            validate ();
       }
       if(x==2){ // Droite
            panelBlocSudWp.setLayout(new FlowLayout( FlowLayout.RIGHT) );
           panelBlocSudWp.setBounds(100, 80, 100, h3);
            System.out.print("SCOOOO");
            validate ();
       }      
...
if ( Desktop.isDesktopSupported() ) {
    ...
    private void checkBoxHeaderWpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkBoxHeaderWpActionPerformed
        if(checkBoxHeaderWp.isSelected()){
            ...
            panelBlocNordWp.setVisible(true);
    ...
    private void checkBoxFooterWpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkBoxFooterWpActionPerformed
        if(checkBoxFooterWp.isSelected()){
            ...
            panelBlocSudWp.setVisible(true);
        }
        else {
            panelBlocFooterWp.setVisible(false);
            panelBlocSudWp.setVisible(false);
    ...
    private void sliderHeightFooterWpStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sliderHeightFooterWpStateChanged
        ...
        if(x==0){ // Milieu
        panelBlocFooterWp.setBounds(47,100-h3,100,h3); //(0 => gauche et (100 => droite
        panelBlocSudWp.setBounds(1,198+(100-h3),198,h3 );
        }
        if(x==1){ //Gauche
            
        panelBlocFooterWp.setBounds(0,100-h3,100,h3); //(0 => gauche et (100 => droite
        panelBlocSudWp.setBounds(1,198+(100-h3),198,h3 );
            
        }
        if(x==2){ //Droite
        
        panelBlocFooterWp.setBounds(100,100-h3,100,h3); //(0 => gauche et (100 => droite
        panelBlocSudWp.setBounds(1,198+(100-h3),198,h3 );    //(x,y placement et x,y taille 
        }
    }//GEN-LAST:event_sliderHeightFooterWpStateChanged

    private void sliderWidthMenuWpStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sliderWidthMenuWpStateChanged
        ...
        if(x==0){ //Gauche
            panelBlocMenuWp.setBounds(0, 50, h4, h5);   // Largeur, hauteur
        }
        if(x==1){ //Droite
            panelBlocMenuWp.setBounds(200-h4, 50, h4, h5);   // Largeur, hauteur
        }
        else{
        System.out.println("La valeur est h4 " + h4);
        panelBlocMenuWp.setSize(h4, h5);
        
        }
        
    }//GEN-LAST:event_sliderWidthMenuWpStateChanged

    private void sliderHeightMenuWpStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sliderHeightMenuWpStateChanged

        /*** Hauteur Menu ***/
        h5=sliderHeightMenuWp.getValue();
        System.out.println("La valeur est h5 " + h5);
        panelBlocMenuWp.setSize(h4, h5);
        
    }//GEN-LAST:event_sliderHeightMenuWpStateChanged

    private void sliderWidthBodyWpStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sliderWidthBodyWpStateChanged
        
//        h6=sliderWidthBodyWp.getValue();
//        
//        if(z==0){   //Droite
//        
//        panelBlocBodyWp.setBounds(100,100,h6,h7); //(0 => gauche et (100 => droite        
//        System.out.println("La valeur est h6 " + h6);
//        }
//        if(z==1){   //Gauche
//        
//        panelBlocBodyWp.setBounds(0,100,h6,h7); //(0 => gauche et (100 => droite      
//        System.out.println("La valeur est h6 " + h6);
//        }
        
    }//GEN-LAST:event_sliderWidthBodyWpStateChanged

    private void sliderHeightBodyWpStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sliderHeightBodyWpStateChanged
...
//        
    ...
    }//GEN-LAST:event_sliderHeightBodyWpStateChanged
    ...
    private void tabbedPanelHeaderWpStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_tabbedPanelHeaderWpStateChanged
        ...
        if (tabbedPanelHeaderWp.getSelectedIndex()==0){
